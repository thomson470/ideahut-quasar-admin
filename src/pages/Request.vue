<template>
    ...
    >
        <q-card :style="($q.screen.lt.md ? '' : 'width: 80vw; max-width: 81vw;')">
            ...
            <q-card-section 
                :style="'overflow: scroll; ' + ($q.screen.lt.md ? 'max-height: 70vh;' : 'max-height: 70vh; width: 80vw; max-width: 81vw;')" 
    ...
    >
        <q-card :style="'width: ' + ($q.screen.lt.md ? '100%;' : '50%;')">
            ...
            >   
                <q-form
                    @submit="on_search_filter_click"
                    @reset="on_search_reset_click"
                >
                    <q-input
